...
const projects = [
{ title: 'Website Barbershop', image:
...
<div class="mb-4"><span v-for="t in project.tech" :key="t" class="inlineblock bg-blue-100 text-blue-800 text-sm font-semibold mr-2 mb-2 px-2.5
